  ...
  return (
    <div className={"w-full flex items-center justify-between gap-x-2 " + containerClass}>
        ...
        <div className="flex items-center gap-x-4">
            <BsHeart className="cursor-pointer w-4 h-4 fill-[var(--color-dark)]" />
            <GoComment className="cursor-pointer w-4 h-4 fill-[var(--color-dark)]" />
            <BsShare className="cursor-pointer w-4 h-4 fill-[var(--color-dark)]" />
        </div>

        <BsBookmark className="cursor-pointer w-4 h-4 fill-[var(--color-dark)]" />
    </div>
  )
}
