...
export function setTheme() {
    ...
    :root {
        ...
        --color-light: hsl(0, 0%, 17%);
        --color-lighter: hsl(0, 0%, 11%);
        --color-gray: hsl(0, 0%, 33%);
        --color-primary: hsl(63, 94%, 58%);
        --color-secondary: hsl(252, 100%, 90%);
        --color-sucsess: hsl(120, 95%, 65%);
        --color-danger: hsl(0, 95%, 65%);
        --color-semidark: hsla(0, 0%, 85%, 0.831);
        --color-dark: hsl(0, 0%, 86%);
        ...
        --logo--color: rgb(255, 255, 255, 0.9);
        ...
        /* NavBar text input */
        --topnavbar__text-input--bg: hsl(0, 0%, 16%);
        --topnavbar__text-input--color: hsl(0, 0%, 85%);
        --topnavbar__text-input__placeholder--text-color: hsl(0, 0%, 53%);
        ...
        --profilecard__email--color: rgba(255, 255, 255, 0.3);
        ...
        --notificationcard1--border-b-color: rgba(255, 255, 25, 0.08);
        ...
        --notificationcard1__date--color: rgba(255, 255, 255, 0.4);
